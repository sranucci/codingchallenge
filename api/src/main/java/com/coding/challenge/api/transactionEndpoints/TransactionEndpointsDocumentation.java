...
public interface TransactionEndpointsDocumentation {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "201", description = "Transaction created", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = StatusOkResponse.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "204", description = "No IDs found", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(type = "integer", format = "int64", description = "Transaction ID")))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Malformed Id", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))),
